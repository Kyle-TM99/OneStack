...
VALUES (1, '회원가입 오류 문의', '회원가입 시 오류가 발생합니다. 어떻게 해결할 수 있나요?', NOW(), NULL, '답변 대기', NULL),
       (2, '배송 문의', '주문한 상품이 아직 도착하지 않았습니다. 언제 도착하나요?', NOW(), NULL, '답변 대기', NULL),
       (3, '환불 요청', '구매한 상품을 환불하고 싶습니다. 절차가 어떻게 되나요?', NOW(), NULL, '답변 대기', NULL),
       (4, '계정 비밀번호 변경', '계정 비밀번호를 변경하고 싶은데, 방법을 알려주세요.', NOW(), NULL, '답변 대기', NULL),
       (5, '상품 리뷰 작성', '상품 리뷰를 작성했는데, 삭제하고 싶습니다. 어떻게 해야 하나요?', NOW(), NULL, '답변 대기', NULL),
       (6, '포인트 적립 문의', '포인트가 적립되지 않았습니다. 확인 부탁드립니다.', NOW(), NULL, '답변 대기', NULL),
       (7, '회원 정보 수정', '회원 정보를 수정하고 싶은데, 어떻게 해야 하나요?', NOW(), NULL, '답변 대기', NULL),
       (8, '광고 메일 수신 해제', '광고 메일 수신을 해제하고 싶습니다. 방법을 알려주세요.', NOW(), NULL, '답변 대기', NULL),
       (9, '상품 교환 문의', '구매한 상품의 교환을 원합니다. 절차가 어떻게 되나요?', NOW(), NULL, '답변 대기', NULL),
       (10, '이벤트 참여 방법', '이벤트에 참여하고 싶은데, 방법을 알려주세요.', NOW(), NULL, '답변 대기', NULL);


-- 회원 문의글 답변 데이터 --
INSERT IGNORE INTO InquiryAnswer (inquiry_no, member_no, inquiry_answer_content, inquiry_answer_file)
VALUES
(1, 1, '안녕하세요, 문의하신 내용에 대한 답변입니다. 해당 문제는 설정에서 해결 가능합니다.', NULL),
(1, 1, '문의 주셔서 감사합니다. 추가 질문이 있으시면 언제든지 남겨주세요.', NULL),
(1, 1, '해당 오류는 최근 업데이트로 인해 발생한 것으로 보입니다. 패치를 진행해 주세요.', NULL),
(2, 2, '안녕하세요, 배송 문의에 대한 답변입니다. 현재 배송 중이며, 곧 도착할 예정입니다.', NULL),
(2, 2, '고객님의 주문 상태를 확인해본 결과, 배송이 지연되고 있는 것으로 확인됩니다. 빠른 시일 내에 도착할 수 있도록 노력하겠습니다.', NULL),
(2, 2, '주문하신 상품의 배송 현황을 추적하여 최신 정보를 제공해드리겠습니다.', NULL),
(3, 3, '안녕하세요, 환불 요청에 대한 답변입니다. 환불 절차는 다음과 같습니다: ...', NULL),
(3, 3, '환불을 진행하려면 먼저 고객센터로 연락해주시기 바랍니다.', NULL),
(3, 3, '환불 요청이 접수되었으며, 처리 기간은 약 3-5일 정도 소요됩니다.', NULL),
(4, 4, '안녕하세요, 계정 비밀번호 변경에 대한 답변입니다. 비밀번호 변경 방법은 다음과 같습니다: ...', NULL),
(4, 4, '비밀번호 변경이 어려우신 경우, 고객센터로 연락해주시면 도움을 드리겠습니다.', NULL),
(4, 4, '비밀번호는 보안상의 이유로 주기적으로 변경하는 것이 좋습니다.', NULL),
(5, 5, '안녕하세요, 상품 리뷰 작성에 대한 답변입니다. 리뷰를 삭제하려면 다음 절차를 따르세요: ...', NULL),
(5, 5, '고객님의 리뷰를 확인한 결과, 삭제 요청이 접수되었습니다.', NULL),
(5, 5, '리뷰 삭제가 완료되었으며, 다른 문의사항이 있으시면 언제든지 연락주세요.', NULL),
(6, 6, '안녕하세요, 포인트 적립 문의에 대한 답변입니다. 포인트 적립 내역을 확인해본 결과, 정상적으로 적립되지 않은 것으로 확인되었습니다.', NULL),
(6, 6, '고객님의 포인트 적립 문제를 해결하기 위해 내부 검토 중입니다.', NULL),
(6, 6, '포인트 적립이 완료되었으며, 확인 부탁드립니다.', NULL),
(7, 7, '안녕하세요, 회원 정보 수정에 대한 답변입니다. 회원 정보를 수정하려면 다음 절차를 따르세요: ...', NULL),
(7, 7, '회원 정보 수정이 완료되었으며, 다른 문의사항이 있으시면 언제든지 연락주세요.', NULL),
(7, 7, '고객님의 요청에 따라 회원 정보가 업데이트되었습니다.', NULL),
(8, 8, '안녕하세요, 광고 메일 수신 해제에 대한 답변입니다. 수신 해제 방법은 다음과 같습니다: ...', NULL),
(8, 8, '광고 메일 수신 해제 요청이 접수되었습니다.', NULL),
(8, 8, '광고 메일 수신이 중단되었으며, 다른 문의사항이 있으시면 언제든지 연락주세요.', NULL),
(9, 9, '안녕하세요, 상품 교환 문의에 대한 답변입니다. 교환 절차는 다음과 같습니다: ...', NULL),
(9, 9, '고객님의 교환 요청이 접수되었습니다.', NULL),
(9, 9, '상품 교환이 완료되었으며, 다른 문의사항이 있으시면 언제든지 연락주세요.', NULL),
(10, 10, '안녕하세요, 이벤트 참여 방법에 대한 답변입니다. 이벤트 참여 방법은 다음과 같습니다: ...', NULL),
(10, 10, '이벤트 참여 신청이 완료되었습니다.', NULL),
(10, 10, '이벤트 참여가 확인되었으며, 추가 문의사항이 있으시면 언제든지 연락주세요.', NULL);