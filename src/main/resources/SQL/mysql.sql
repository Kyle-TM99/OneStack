...
CREATE TABLE Member (
                        ...
                        member_type   TINYINT DEFAULT 0 NOT NULL, -- 0(초보자) 1(전문가) --
                        member_status INTEGER DEFAULT 0 NOT NULL, -- 0(정상) 1(정지) 2(탈퇴) --
...
CREATE TABLE ProfessionalAdvancedInformation (
...
CREATE TABLE Community (
                           ...
                           community_reply_count INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE Manager (
                         manager_no INTEGER AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE ManagerLog (
                            log_no INTEGER AUTO_INCREMENT PRIMARY KEY,
                            manager_no INTEGER NOT NULL,
                            member_no INTEGER NOT NULL,
